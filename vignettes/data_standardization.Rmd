...
```{r, echo = FALSE}
excel_path <- system.file("extdata", "DatasetFormat.xlsx", package = "prey_data_processing")
...
```{r}
excel_path <- system.file("extdata", "corline", "Zoop2013_2016_NC.xlsx", package = "prey_data_processing")
...
#2019
path <- system.file("extdata", "cordoleani", "DailyCageFish_data_2019.csv", package = "prey_data_processing")
fish_growth_data_2019 <- read_csv(path)

#2020
path <- system.file("extdata", "cordoleani", "DailyCageFish_data_2020.csv", package = "prey_data_processing")
...
path <- system.file("extdata", "cordoleani", "CageSalmon_Growth.csv", package = "prey_data_processing")
...
```{r message=FALSE, warning=FALSE}
path <- system.file("extdata", "cordoleani", "tidy_zoop_density.csv", package = "prey_data_processing")
...
path <- system.file("extdata", "cordoleani", "Cage_Locations.csv", package = "prey_data_processing")
...
path <- system.file("extdata", "cordoleani", "doboall.csv", package = "prey_data_processing")
...
```{r}
path <- system.file("extdata", "zeug", "san_joaquin", "summary_zooplankton_10_19_17.xlsx", package = "prey_data_processing")
...
path <- system.file("extdata", "zeug", "merced", "Merced invert data_environment.xls", package = "prey_data_processing")
...
```{r}
path <- system.file("extdata", "zeug", "merced", "salmon data_final(Josie).xlsx", package = "prey_data_processing")
...
```{r}
path <- system.file("extdata", "zeug", "merced", "Temperature.xlsx", package = "prey_data_processing")
...
path <- system.file("extdata", "zeug", "merced", "Flow_meter_Drift.xlsx", package = "prey_data_processing")
...
```{r}
path <- system.file("extdata", 'guignard', "Honolulu Bar data.xlsx", package = "prey_data_processing")
stanislaus_zoop_raw <- readxl::read_excel(path, sheet = 'Density by location, date,ta_MR')


path <- system.file("extdata", 'guignard', "Honolulu Bar data_05062022.xlsx", package = "prey_data_processing")
...
```{r}
path <- system.file("extdata", 'guignard', "drift net sites_to_kml.kml", package = "prey_data_processing")
...
path <- system.file("extdata", "montgomery", "food_4_fish_data_access.R", package = "prey_data_processing")
source(path)
```
...
path <- system.file("extdata", "montgomery",  "mont_locations.csv", package = "prey_data_processing")
...
path <- system.file("extdata", "zooper", "zoop_data.rds", package = "prey_data_processing")
...
path <- system.file("extdata", "zooper", "shape_files", "delta_extents", "HabitatExtentsForCorreigh.shp", package = "prey_data_processing")
