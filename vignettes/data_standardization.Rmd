...
```{r}
excel_path <- system.file("extdata", "corline", "Zoop2013_2016.xlsx", package = "DSMprey")
...
# View(all_prey)
# saveRDS(all_prey, '../preliminary data/aggregated_prey_data.rds')
...
# saveRDS(all_fish, '../preliminary data/aggregated_fish_data.rds')
...
#saveRDS(all_enviro, '../preliminary data/aggregated_enviro_data.rds')
```
