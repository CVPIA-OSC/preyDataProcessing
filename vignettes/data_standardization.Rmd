...
```{r, echo = FALSE}
excel_path <- system.file("extdata", "DatasetFormat.xlsx", package = "DSMprey")
...
```{r}
excel_path <- system.file("extdata", "corline", "Zoop2013_2016_NC.xlsx", package = "DSMprey")
...
#2019
path <- system.file("extdata", "cordoleani", "DailyCageFish_data_2019.csv", package = "DSMprey")
fish_growth_data_2019 <- read_csv(path)

#2020
path <- system.file("extdata", "cordoleani", "DailyCageFish_data_2020.csv", package = "DSMprey")
...
path <- system.file("extdata", "cordoleani", "CageSalmon_Growth.csv", package = "DSMprey")
...
```{r message=FALSE, warning=FALSE}
path <- system.file("extdata", "cordoleani", "tidy_zoop_density.csv", package = "DSMprey")
...
path <- system.file("extdata", "cordoleani", "Cage_Locations.csv", package = "DSMprey")
...
path <- system.file("extdata", "cordoleani", "doboall.csv", package = "DSMprey")
...
```{r}
path <- system.file("extdata", "zeug", "san_joaquin", "summary_zooplankton_10_19_17.xlsx", package = "DSMprey")
...
path <- system.file("extdata", "zeug", "merced", "Merced invert data_environment.xls", package = "DSMprey")
...
```{r}
path <- system.file("extdata", "zeug", "merced", "salmon data_final(Josie).xlsx", package = "DSMprey")
...
```{r}
path <- system.file("extdata", "zeug", "merced", "Temperature.xlsx", package = "DSMprey")
...
path <- system.file("extdata", "zeug", "merced", "Flow_meter_Drift.xlsx", package = "DSMprey")
...
```{r}
path <- system.file("extdata", 'guignard', "Honolulu Bar data.xlsx", package = "DSMprey")
stanislaus_zoop_raw <- readxl::read_excel(path, sheet = 'Density by location, date,ta_MR')


path <- system.file("extdata", 'guignard', "Honolulu Bar data_05062022.xlsx", package = "DSMprey")
...
```{r}
path <- system.file("extdata", 'guignard', "drift net sites_to_kml.kml", package = "DSMprey")
...
#          species = Order, 
#          date = Date) %>%
#   group_by(species, site, date, `Volume sampled`) %>%
#   summarise(sum_count = sum(Count, na.rm = TRUE)) %>%
#             #sum_volume = sum(`Volume sampled`)) %>%
#   mutate(prey_density = sum_count/`Volume sampled`/28.3168,
#          species = tolower(species),
...
#   
# %>%
#   select(-`...1`, -c(`Flow (mean of 2)`:`# of picked subsamples`), 
#          -Family, -Count, -Notes)
...
# stanislaus_zoop_2 <- merge(stanislaus_zoop_2, locations, by = 'site') %>% 
#   select(-Description) 
```

```{r}

# stanislaus_zoop$file <-  "old"
# stanislaus_zoop_2$author <-  "Guignard_updated"
# 
...
# 
# 
# all_prey <- bind_rows(all_prey, stanislaus_zoop_2)
# 
...
path <- system.file("extdata", "montgomery", "food_4_fish_data_access.R", package = "DSMprey")
source(path)
```
...
path <- system.file("extdata", "montgomery",  "mont_locations.csv", package = "DSMprey")
...
path <- system.file("extdata", "zooper", "zoop_data.rds", package = "DSMprey")
...
path <- system.file("extdata", "zooper", "shape_files", "delta_extents", "HabitatExtentsForCorreigh.shp", package = "DSMprey")
